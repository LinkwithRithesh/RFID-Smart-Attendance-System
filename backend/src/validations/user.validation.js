...
const updateUserSchema = z.object({
  ...
  body: z
    .object({
      ...
      isActive: z.boolean().optional(), password: z.string().optional(), status: z.string().optional(), faceFileName: z.string().optional(),
      profile: z
        .object({
          rollNumber: z.string().min(1).optional(), dob: z.string().optional(), gender: z.string().optional(),
